...
public final class PublishMvcSupport {

    public static final String PUBLISH_PREVIEW_IMAGE_PATH = "/publish/preview-image";
    ...
    private void addSummaryData(final ModelAndView mav, final PublishBoatForm form, final Locale locale) {
        ...
        mav.addObject("uploadedImagePreviewUrls", PublishMvcSupport.buildUploadedImagePreviewUrls(form));
