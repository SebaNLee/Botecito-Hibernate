  ...
  <div class="card-body p-5 gap-3">
    <div class="flex items-start justify-between gap-4">
      ...
      <div class="text-right">
        <p class="font-headline text-2xl font-extrabold text-primary m-0">$<fmt:formatNumber value="${price}" type="number" groupingUsed="true" maxFractionDigits="0" /></p>
    ...
    <div class="card-actions flex items-center justify-between gap-3 border-t border-outline-variant/40 pt-4 text-sm text-on-surface-variant">
      ...
      <span><fmt:formatNumber value="${weight}" type="number" groupingUsed="true" maxFractionDigits="0" /> kg</span>
