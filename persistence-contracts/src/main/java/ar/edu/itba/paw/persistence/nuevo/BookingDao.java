...
public interface BookingDao {
    ...
    /** Interval is valid for availability but overlaps another blocking booking (including clearance). */
    ...
    /**
     * Inserts a {@code PENDING} booking when the request is valid, the interval lies entirely inside
     * one availability window for the version (interpreted in {@code version.timezone}), and UTC
     * bounds do not collide with another blocking booking on the same version (including the
     * configured minute gap).
     *
     * @return new booking id (positive), {@link #RESULT_OUTSIDE_AVAILABILITY}, or {@link
