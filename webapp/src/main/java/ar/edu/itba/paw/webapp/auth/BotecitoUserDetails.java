...
/**
 * Authenticated principal. Spring Security stores the login email as {@link #getUsername()};
 * there is no separate username. {@link #isEnabled()} reflects email verification ({@code Users.verified}).
 */
@Getter
