...
CREATE TABLE item_booking (
    ...
    start_time TIMESTAMP WITH TIME ZONE NOT NULL,
    end_time TIMESTAMP WITH TIME ZONE NOT NULL,
    state VARCHAR(30) NOT NULL DEFAULT 'BOOKING_PENDING',
    request_message VARCHAR(5000),
    host_decision_token VARCHAR(120) NOT NULL,
    host_decision_used_at TIMESTAMP WITH TIME ZONE,
    created_at TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT chk_booking_state CHECK (state IN ('BOOKING_PENDING', 'BOOKING_CONFIRMED', 'BOOKING_REJECTED', 'BOOKING_CANCELLED', 'BOOKING_COMPLETED'))
);
