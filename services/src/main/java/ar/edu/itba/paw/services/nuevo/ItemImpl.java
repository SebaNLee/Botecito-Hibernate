...
public class ItemImpl implements ItemInterface {
    ...
    public boolean updateMyBoatsItem(final int itemId, final int ownerId,
        ...
        return itemDao.updateMyBoatsItem(itemId, ownerId, title, description,
                pricePerHour, difficultyLevel, locationOptionId);
    }
    ...
    public int createPublicationVersion(final int itemId, final int ownerId,
            final String title, final String description,
            final int pricePerHour, final Integer difficultyLevel, final int locationOptionId) {
        return itemDao.createPublicationVersion(itemId, ownerId, title, description,
                pricePerHour, difficultyLevel, locationOptionId);
    }
