...
<paw:layout
  ...
  scripts="search-filters,edit-wizard">
  <div
  ...
  >
    ...
    <div class="mb-10">
      ...
      >
        <span><spring:message code="editPublication.step1.progress" /></span>
        <span><spring:message code="editPublication.step1.badge" /></span>
      </div>
      <progress
      ...
      >
        <spring:message code="editPublication.step1.title" />
      </h1>
