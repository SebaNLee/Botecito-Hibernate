...
public interface BookingDao {
    ...
    Optional<Integer> insertBooking(int versionId, int guestId,
            LocalDateTime utcStart, LocalDateTime utcEnd,
            BookingStatusEnumOrm status, String msg);
    ...
    BookingSearchResult searchBookings(int userId, boolean asHost,
            String searchQuery, LocalDate date, BookingStatusEnumOrm status,
