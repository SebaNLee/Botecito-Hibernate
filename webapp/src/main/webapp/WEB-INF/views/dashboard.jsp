                    ...
                    <div class="rounded-xl bg-base-200 p-4 space-y-4">
                      ...
                      <div class="rounded-lg bg-base-100 p-3 space-y-2">
                        ...
                        <c:if test="${not empty receivedRequest.paymentAlias}">
                          <p class="m-0 break-all text-xs text-on-surface-variant"><c:out value="${paymentInfoAliasLabel}" />: <c:out value="${receivedRequest.paymentAlias}" /></p>
                        </c:if>
                      </div>
                    ...
                    <div class="rounded-xl bg-base-200 p-4 space-y-4">
                      ...
                      <div class="rounded-lg bg-base-100 p-3 space-y-2">
                        ...
                        <c:if test="${not empty sentRequest.paymentAlias}">
                          <p class="m-0 break-all text-xs text-on-surface-variant"><c:out value="${paymentInfoAliasLabel}" />: <c:out value="${sentRequest.paymentAlias}" /></p>
                        </c:if>
                      </div>
                      ...
                      <c:if test="${sentRequest.statusMessageCode == 'profile.sentBookings.status.paymentRefused'}">
                        <div class="rounded-lg bg-info/10 p-3 border-l-4 border-info space-y-2">
                          <p class="m-0 text-[11px] font-bold uppercase tracking-wider text-info"><spring:message code="payment.refused.banner" /></p>
